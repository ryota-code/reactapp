...
import {
  GenreCoupleBody,
  GenreCoupleBodyProps
} from "../../Components/Organism/GenreCoupleBody";

interface Props extends RouteComponentProps<{}> {
  actions: ActionDispatcher;
}
export const GenreCouple: React.FC<Props> = props => {
  const genreCoupleBodyProps: GenreCoupleBodyProps = {
    headerProps: {
      buttonProps1: {
        buttonType: 1,
        label: "音声の投稿",
  ...
  return (
    <>
      <GenreCoupleBody {...genreCoupleBodyProps} />
    </>
  );
};
